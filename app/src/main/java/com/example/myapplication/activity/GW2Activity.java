...
public class GW2Activity extends AppCompatActivity {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                potgwPopupButton.setOnClickListener(v -> {
                    ...
                    if (currentUser != null) {
                        ...
                        DetailsUtils.showAllPlayersPopup(GW2Activity.this,username,"Demo1");
                    } else {
                    }
                });
                ...
                teamPlayersPopupButton.setOnClickListener(v -> {
                    ...
                    if (currentUser != null) {
                        ...
                        DetailsUtils.showPlayersPopupForTeams(GW2Activity.this, "T1", "T2", username, "M1");
                    } else {
                    }
                });
                ...
                teamPlayersPopupButton2.setOnClickListener(v -> {
                    ...
                    if (currentUser != null) {
                        ...
                        DetailsUtils.showPlayersPopupForTeams(GW2Activity.this, "T10", "T11", username, "M20");
                    } else {
                    }
                });
                ...
                teamPlayersPopupButton3.setOnClickListener(v -> {
                    ...
                    if (currentUser != null) {
                        ...
                        DetailsUtils.showPlayersPopupForTeams(GW2Activity.this, "T3", "T4", username, "M21");
                    } else {
                    }
                });
                ...
                teamPlayersPopupButton4.setOnClickListener(v -> {
                    ...
                    if (currentUser != null) {
                        ...
                        DetailsUtils.showPlayersPopupForTeams(GW2Activity.this, "T5", "T6", username, "M22");
                    } else {
                    }
                });
    ...
    public void confirmPredictionForFcsbCfr(View view) {
        ...
        if (firebaseUser != null) {
            ...
            inputUtils.checkExistingInputs(GW2Activity.this, fcsbCfr.getId(), userId, homeGoals, awayGoals);
        }
